  ...
  return (
    <div className="min-h-screen bg-surface flex flex-col items-center pb-24">
      <div className="w-full max-w-[640px] flex flex-col gap-md p-gutter md:p-lg">
        ...
        <div className="bg-surface-container-lowest border border-outline-variant border-l-4 rounded-xl p-md flex flex-col gap-sm" style={{ borderLeftColor: meta.color }}>
          <div className="flex items-center gap-2 font-label-bold text-label-bold tracking-wide" style={{ color: meta.color }}>
